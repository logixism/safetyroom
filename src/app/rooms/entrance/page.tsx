...
const circles: PulsingCircleProps[] = [
    ...
    },
    {
        content: (
            <>
                <img
                    src="../assets/hires/signs/fire_car.png"
                    alt="Пожежна машина"
                />
            </>
        ),
            ...
            <>
                <div>
                    {[...Array(3).keys()].map((i) => (
                        <img
                            key={i}
                            src={`../assets/hires/signs/shelf_overload_${
                                i + 1
                            }.png`}
                            alt={`Буклет ${i + 1}`}
                            className="w-full"
            ...
            <>
                <div>
                    {[...Array(3).keys()].map((i) => (
                        <img
                            key={i}
                            src={`../assets/hires/signs/traffic_light_${
                                i + 1
                            }.png`}
                            alt={`Буклет ${i + 1}`}
                            className="w-full"
...

    {
        ...
        onClick: () => {
            if (!fire_audio) {
                fire_audio = new Audio("../assets/sounds/air_raid.mp3");
            ...
            <>
                <div>
                    {[...Array(2).keys()].map((i) => (
                        <img
                            key={i}
                            src={`../assets/hires/signs/cyberbullying_${
                                i + 1
                            }.png`}
                            alt={`Буклет ${i + 1}`}
                            className="w-full"
